...
export default function EventDetailPage() {
  ...
  const getEventStatus = (): "upcoming" | "ongoing" | "expired" => {
  ...
  const eventTimingStatus: "upcoming" | "ongoing" | "expired" =
    getEventStatus();
  ...
  const getStatusBadge = () => {
    ...
    switch (eventTimingStatus) {
      case "ongoing":
        return { variant: "default" as const, text: "Event Ongoing" };
      case "expired":
        return { variant: "secondary" as const, text: "Event Ended" };
      case "upcoming":
      default:
        return event?.status === "published"
          ? { variant: "default" as const, text: "Accepting Registrations" }
          : { variant: "secondary" as const, text: event?.status || "Draft" };
    }
  };
  ...
  const isEventManager = session?.user && event?.managerId === session.user.id;
              ...
              <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                ...
                {event.maxCapacity && (
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {currentRegistrations} / {event.maxCapacity} registered
                    </span>
                  </div>
                )}
              </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-medium">Keynote Presentation</p>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-medium">Workshops & Breakout Sessions</p>
                    <p className="text-sm text-muted-foreground">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                      <span className="text-lg font-medium">EM</span>
                    </div>
                    <div>
                      <p className="font-medium">Event Manager</p>
                      <p className="text-sm text-muted-foreground">
                        Manager ID: {event.managerId.substring(0, 8)}...
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    {event.maxCapacity
                      ? event.maxCapacity - currentRegistrations
                      : "Unlimited"}{" "}
                    {event.maxCapacity ? "spots remaining" : "capacity"}
                  </p>
                </div>
                ...
                {event.status === "running" && userRegistration ? (
                  <Link
