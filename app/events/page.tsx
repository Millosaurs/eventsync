...
export default function EventsPage() {
  ...
  const filteredEvents = events.filter((event) => {
    ...
    if (selectedTimeStatus !== "all") {
      ...
      if (timeStatus.label.toLowerCase() !== selectedTimeStatus) {
        return false;
      }
    }
      ...
      <div className="container mx-auto px-4 py-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Select
            ...
            onValueChange={setSelectedTimeStatus}
          >
          ...
          <>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredEvents.map((event) => {
                ...
                const spotsLeft = capacity > 0 ? capacity - registered : 0;
                          ...
                          {(() => {
                            ...
                            return (
                              <Badge
                                ...
                                className={
                                  timeStatus.label === "Ongoing"
                                    ? "bg-green-500 hover:bg-green-600"
                                    : timeStatus.label === "Expired"
